        ...
        <div className='container'>
            ...
            <div className='row my-3 py-3'>
                <div className='d-flex justify-content-between align-items-center'>
                    <h2 style={{ color: "#19376D" }}> Available Cooks : </h2>
                ...
                <hr></hr>
                {workerLoad && <Spinner />}
                {!workerLoad && <h5>{verifiedWorkers.length === 0 && `No Cooks found.`}</h5>}
                {!workerLoad && verifiedWorkers.filter(w => w.occupation === "Cook").map((worker) => {
