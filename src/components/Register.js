            ...
            <div className="col-sm-6">
                    <div className="card">
                        <div className="card-body">
                            ...
                            <p className="card-text">as Worker</p>
                            <Link to='/WorkerRegister' className="btn btn-primary">Worker Register</Link>
                        </div>
                    </div>
                </div>
                ...
                <div className="col-sm-6">
                    <div className="card">
                        <div className="card-body">
                            <h5 className="card-title">Register</h5>
                            <p className="card-text">as User</p>
                            <Link to='/AdminLogin' className="btn btn-primary">User Register</Link>
                        </div>
                    </div>
                </div>
